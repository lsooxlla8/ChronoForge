...
### 5.6 Prediction-Residual Datamosh
...
### 5.10 Reaction-Diffusion Injector
...
### 5.11 Distance-Field Topography
...
### 5.18 Temporal Morphology Relay
...
### 5.19 Scan Slice Field — эффект по разбору референса
