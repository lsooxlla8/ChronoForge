...
- Контекстные `?` из toolbar и Inspector открывают общую справку или страницу выбранного эффекта; каталог Help автоматически проверяется против `EffectDefinition`.
