...
- Current Frame release-gate matrix проверяет все 21 эффекты на movie и alpha-bearing PNG fixtures, first/middle/last timeline positions, A/B graphs, premultiplied RGBA и cold/warm cache paths.
