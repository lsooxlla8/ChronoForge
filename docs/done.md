# Сделано — ChronoForge 1.1

Релиз: **1.1.0**, 19 июля 2026 года.
...
- Current Frame release-gate matrix проверяет 2 149 конфигураций: все дискретные режимы и их допустимые комбинации у каждого эффекта, скрытую ветку 3D Rotation, Output Prefilter и все семь Amount Blend в сочетании с каждой совместимой конфигурацией эффекта. На movie и alpha-bearing PNG fixtures выполняются first/middle/last, A/B graph, premultiplied RGBA, cold/warm cache и 12 894 byte-for-byte сравнений с PNG Sequence.
